...
const Home = () => {
  ...
  return (
    <Box>
      ...
      <section className="bg-heroBanner bg-cover bg-center bg-no-repeat h-[100vh]">
        <Box className="flex flex-col justify-center align-center px-12 h-full w-full lg:px-24 ">
          <h3 className="text-white text-2xl g:text-3xl font-subtitle">Trade-in-offer</h3>
          <h3 className="text-white text-5xl lg:text-6xl font-semibold font-subtitle">
            Super Value Deals
          </h3>
          <h3 className="text-red text-5xl lg:text-6xl font-semibold font-subtitle">
            On All Products
          </h3>
          <h3 className="text-white text-md lg:text-lg font-subtitle italic">
            Save more with coupons & up to 70% Off!
          </h3>
          <button className="w-[140px] text-center text-white font-medium font-subtitle text-lg bg-shopNow py-4 bg-no-repeat bg-center">
            Shop Now
          </button>
        </Box>
      </section>
