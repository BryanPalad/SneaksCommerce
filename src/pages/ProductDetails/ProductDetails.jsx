        ...
        <Box className="flex flex-col justify-between items-center gap-8 px-12 lg:px-24 h-auto w-full lg:h-[90vh] lg:gap-8 lg:flex-row">
          ...
          <Box className="flex flex-col w-full lg:w-[40%] space-y-1">
              <NavLink to={"/"} className='flex gap-1'>
                <BiArrowBack className="flex items-start text-2xl lg:text-3xl mb-2 mt-2 lg:mt-0" />
                <h4 className="text-md mt-2 lg:text-xl lg:mt-0">Back</h4>
              </NavLink>
          ...
          <Box className="flex flex-col space-y-2 w-full lg:w-[60%]">
            <h4 className="text-2xl lg:text-3xl font-subtitle font-semibold">
              {product.title}
            </h4>
            <h4 className="text lg lg:text-xl font-normal font-subtitle">
              {product.brand}
            </h4>
            <h4 className="text-xl lg:text-2xl font-subtitle text-red">
              ₱{product.origPrice}
            </h4>
            <input
              type="number"
            ...
            <Box className="flex flex-col items-start space-x-0 space-y-2 lg:items-center lg:space-x-4 lg:space-y-0 lg:flex-row">
              ...
              <button
                type="button"
                className="w-[120px] bg-button px-2 py-2 rounded-lg text-white font-medium font-subtitle"
                onClick={() =>
                  addToCart(
                    product.id,
                    product.img,
            ...
            <h4 className="text-xl lg:text-2xl text-black font-subtitle pt-8">
              ~Product Details~
            </h4>
            <h4 className="text-lg lg:text-xl font-main font-normal text-justify">
              {product.description}
            </h4>
          </Box>
        </Box>
