...
const Banner = (props) => {
    const {bannerTitle, bannerSubtitle} = props;
  return (
    <Box className='flex flex-col justify-center items-center w-full bg-shopBanner bg-cover bg-center mt-24 h-[40vh] gap-2'>
